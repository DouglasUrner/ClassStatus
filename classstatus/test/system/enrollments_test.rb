...
class EnrollmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Enrollment" do
    ...
    fill_in "Dropped course", with: @enrollment.dropped_course
    fill_in "Joined course", with: @enrollment.joined_course
    fill_in "Joined section", with: @enrollment.joined_section
